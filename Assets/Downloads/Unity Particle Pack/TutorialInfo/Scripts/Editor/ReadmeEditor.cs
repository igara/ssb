...
public class ReadmeEditor : Editor
{
    ...
    static void LoadLayout()
    {
        ...
        var windowLayoutType =
            assembly.GetType("UnityEditor.WindowLayout", true);
        var method =
            windowLayoutType
                .GetMethod("LoadWindowLayout",
    ...
    static Readme SelectReadme()
    {
        ...
        if (ids.Length == 1)
        {
            var readmeObject =
                AssetDatabase
                    .LoadMainAssetAtPath(AssetDatabase.GUIDToAssetPath(ids[0]));
    ...
    bool LinkLabel(GUIContent label, params GUILayoutOption[] options)
    {
        ...
        Handles
            .DrawLine(new Vector3(position.xMin, position.yMax),
