...
namespace UnityChan
{
    ...
    public class CameraController : MonoBehaviour
    {
        ...
        void OnGUI()
        {
            ...
            {
                GUI
                    .Box(new Rect(Screen.width - 210,
                        Screen.height - 100,
                        200,
                        90),
                    "Camera Operations");
                GUI
                    .Label(new Rect(Screen.width - 200,
                        Screen.height - 80,
                        200,
                        30),
                    "RMB / Alt+LMB: Tumble");
        ...
        void mouseEvent()
        {
            ...
            if (delta != 0.0f) this.mouseWheelEvent(delta);

            if (
                Input.GetMouseButtonDown((int) MouseButtonDown.MBD_LEFT) ||
        ...
        void mouseDragEvent(Vector3 mousePos)
        {
            ...
            if (Input.GetMouseButton((int) MouseButtonDown.MBD_LEFT))
            {
                ...
                else //Operation for Mac : "Left Alt + LMB Drag" is Tumble
